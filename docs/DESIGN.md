...
| 10  | `feat: push notifications and permissions`                        | FCM + APNs, @notifee channels + actions, react-native-permissions flow                                                                                                                             |
...
| #   | Commit                                                            | What you learn                                                                                                                                                                                                                                                                                                                             |
| --- | ----------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 11  | `feat: forms with React Hook Form and Zod`                        | Controlled inputs, schema validation, multi-step forms                                                                                                                                                                                                                                                                                     |
| 12  | `feat: animations, bottom sheet, and modals`                      | Reanimated 3, gesture handlers, @gorhom/bottom-sheet, modal/action sheet patterns                                                                                                                                                                                                                                                          |
| 13  | `feat: realtime with WebSocket, Socket.IO, and AppState`          | WS lifecycle, Zustand real-time store, reconnect on foreground, AppState API                                                                                                                                                                                                                                                               |
| 14  | `feat: webview with JS bridge and OAuth flow`                     | react-native-webview, postMessage bridge, in-app browser, OAuth redirect handling                                                                                                                                                                                                                                                          |
| 15  | `test: unit, component, and integration tests`                    | RNTL setup, store tests, screen integration tests                                                                                                                                                                                                                                                                                          |
| 16  | `dx: code snippets and feature generator`                         | Plop.js scaffolding, VS Code snippets, CLAUDE.md conventions                                                                                                                                                                                                                                                                               |
| 17  | `feat: Turbo Native Module with iOS and Android`                  | Codegen spec, Swift + Kotlin bridge, New Architecture                                                                                                                                                                                                                                                                                      |
| 18  | `feat: crash reporting and error boundaries with Sentry`          | Sentry init, error boundaries, breadcrumbs, performance tracing                                                                                                                                                                                                                                                                            |
| 19  | `feat: performance — FlashList, memoization, profiling`           | @shopify/flash-list, memo/useMemo/useCallback patterns, React DevTools Profiler                                                                                                                                                                                                                                                            |
